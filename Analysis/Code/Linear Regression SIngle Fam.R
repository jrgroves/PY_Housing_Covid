...
stargazer(mod1, mod2, mod3, mod4, mod5, mod6, type = "text", 
          out="./Analysis/Output/Reg1sf.txt")
save(mod1, mod2, mod3, mod4, mod5, mod6, file="./Analysis/Output/Reg1sf.RData")
...
save(mod1, mod2, mod3, mod4, mod5, mod6, file="./Analysis/Output/Reg1sf_Robust.RData")
rob.xlsx <- write.xlsx(OUT, file = "./Analysis/Output/Reg1_Robsf.xlsx", asTable = FALSE)
...
save(mod1, mod2, mod3, mod4, mod5, mod6, file="./Analysis/Output/Reg2sf_Robust.RData")
...
rob.xlsx <- write.xlsx(OUT, file = "./Analysis/Output/Reg2sf_Rob.xlsx", asTable = FALSE)
...
save(mod1, mod2, mod3, mod4, mod5, mod6, file="./Analysis/Output/Reg2sfs_Robust.RData")
...
rob.xlsx <- write.xlsx(OUT, file = "./Analysis/Output/Reg2sfs_Rob.xlsx", asTable = FALSE)
